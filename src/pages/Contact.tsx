...
import { Mail, MapPin, Phone, Send, Twitter, Instagram, Youtube, Github } from 'lucide-react';
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-violet-600/20 p-3 rounded-lg text-violet-400 hover:text-white hover:bg-violet-600/30 transition-all duration-300">
                    <Twitter size={24} />
                  </a>
                  <a href="#" className="bg-violet-600/20 p-3 rounded-lg text-violet-400 hover:text-white hover:bg-violet-600/30 transition-all duration-300">
                    <Instagram size={24} />
